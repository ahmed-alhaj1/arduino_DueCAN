...
// this function I used to set the heart beat after finishing parsing.
void HeartBeat::set_elapse_time(unsigned long elapse_time){
  this->elapse_time = elapse_time; 
}

// get the time for the heartbeat
...
void ControllerParser::set_control_array() {
	  ...
	  int16_t butt1, butt2;
	  //the value for button are mapped in using truth table as follows. the point is to address if there is more than one button clicked at time. 
	  // button_set1
	  //value | up | down | left | right |
	  //0000  | 0  | 0    | 0    |   0   | = nothing clicked
	  //0001  | 0  | 0    | 0    |   1   | = right  clicked
	  //0010  | 0  | 0    | 1    |   0   | = left  clicked
	  //0011  | 0  | 0    | 1    |   1   | = right and left clicked at same time
	  //0100  | 0  | 1    | 0    |   0   | = down clicked
	  //0101  | 0  | 1    | 0    |   1   | = down and right clicked
	  // so on and so for.

	  if (!get_butt_set1_up() && !get_butt_set1_down() && !get_butt_set1_left() && !get_butt_set1_right()) butt1 = 0x00;        // 0

	  else if (!get_butt_set1_up()  && !get_butt_set1_down() && !get_butt_set1_left()  && !!get_butt_set1_right()) butt1 = 0x01; // 1-right
	  else if (!get_butt_set1_up()  && !get_butt_set1_down() && !!get_butt_set1_left() && !get_butt_set1_right()) butt1 = 0x02; // 2- left
	  else if (!get_butt_set1_up()  && !get_butt_set1_down() && !!get_butt_set1_left() && !!get_butt_set1_right()) butt1 = 0x03; // 3- right + left
	  else if (!get_butt_set1_up()  && !!get_butt_set1_down() && !get_butt_set1_left()  && !get_butt_set1_right()) butt1 = 0x04; // 4- down

	  else if (!get_butt_set1_up()  && !!get_butt_set1_down()  && !get_butt_set1_left() && !!get_butt_set1_right()) butt1 = 0x05; // 5 down + right 
	  else if (!get_butt_set1_up() && !!get_butt_set1_down() && !!get_butt_set1_left() && !get_butt_set1_right()) butt1 =  0x06; // 6 left + down
	  else if (!get_butt_set1_up() && !!get_butt_set1_down()  && !!get_butt_set1_left() && !!get_butt_set1_right()) butt1 =  0x07; // 7 right + left + down

	  else if (!!get_butt_set1_up()  && !get_butt_set1_down()  && !get_butt_set1_left()  && !get_butt_set1_right()) butt1 =   0x08; // 8 up 
	  else if (!!get_butt_set1_up() && !get_butt_set1_down()  &&  !get_butt_set1_left() && !!get_butt_set1_right()) butt1 =   0x09;  // 9 right + up
	  else if (!!get_butt_set1_up() && !get_butt_set1_down() && !!get_butt_set1_left()  && !get_butt_set1_right()) butt1 =   0x0A;  // left + up

	  else if (!!get_butt_set1_up() && !get_butt_set1_down() && !!get_butt_set1_left()  && !!get_butt_set1_right()) butt1 = 0x0B; // 11 right +left+ up
	  else if (!!get_butt_set1_up() && !!get_butt_set1_down() && !get_butt_set1_left() &&  !get_butt_set1_right()) butt1 = 0x0C; // 12 down +  up  
	  else if (!!get_butt_set1_up() && !!get_butt_set1_down() && !get_butt_set1_left() && !!get_butt_set1_right()) butt1 = 0x0D; // 13 right +down + up
	  else if (!!get_butt_set1_up() && !!get_butt_set1_down() && !!get_butt_set1_left() && !!get_butt_set1_right()) butt1 = 0x0E; // 14 left +down + up
	  else if (!!get_butt_set1_up() && !!get_butt_set1_down() && !!get_butt_set1_left() && !!get_butt_set1_right()) butt1 =  0x0F; // 15 right left down up
	   
	  
	  
	  
	  //set button_set2 
	  // same logic for button set one
	  if (!get_butt_set2_up() && !get_butt_set2_down() && !get_butt_set2_left() && !get_butt_set2_right()) butt2 = 0x00;        // 0

	  else if (!get_butt_set2_up() && !get_butt_set2_down() && !get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x01; // 1-right
	  else if (!get_butt_set2_up() && !get_butt_set2_down() && !!get_butt_set2_left() && !get_butt_set2_right()) butt2 = 0x02; // 2- left
	  else if (!get_butt_set2_up() && !get_butt_set2_down() && !!get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x03; // 3- right + left
	  else if (!get_butt_set2_up() && !!get_butt_set2_down() && !get_butt_set2_left() && !get_butt_set2_right()) butt2 = 0x04; // 4- down

	  else if (!get_butt_set2_up() && !!get_butt_set2_down() && !get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x05; // 5 right + down 
	  else if (!get_butt_set2_up() && !!get_butt_set2_down() && !!get_butt_set2_left() && !get_butt_set2_right()) butt2 = 0x06; // 6 left + down
	  else if (!get_butt_set2_up() && !!get_butt_set2_down() && !!get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x07; // 7 right + left + down

	  else if (!!get_butt_set2_up() && !get_butt_set2_down() && !get_butt_set2_left() && !get_butt_set2_right()) butt2 = 0x08; // 8 up 
	  else if (!!get_butt_set2_up() && !get_butt_set2_down() && !get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x09;  // 9 right + up
	  else if (!!get_butt_set2_up() && !get_butt_set2_down() && !!get_butt_set2_left() && !get_butt_set2_right()) butt2 = 0x0A;  // left + up

	  else if (!!get_butt_set2_up() && !get_butt_set2_down() && !!get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x0B; // 11 right +left+ up
	  else if (!!get_butt_set2_up() && !!get_butt_set2_down() && !get_butt_set2_left() && !get_butt_set2_right()) butt2 = 0x0C; // 12 down +  up  
	  else if (!!get_butt_set2_up() && !!get_butt_set2_down() && !get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x0D; // 13 right +down + up
	  else if (!!get_butt_set2_up() && !!get_butt_set2_down() && !!get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x0E; // 14 left +down + up
	  else if (!!get_butt_set2_up() && !!get_butt_set2_down() && !!get_butt_set2_left() && !!get_butt_set2_right()) butt2 = 0x0F; // 15 right left down up
